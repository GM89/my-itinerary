...
const GoogleAuthButton = () => {
    ...
    const {  isSignedIn } = isSignedInState;
...
/*         function authButton2  () { 
            console.log(isSignedInState,'ciao')
            if (isSignedInState === null) {
                console.log(isSignedInState,'null')
                return (
                    <button type="button" onClick={onSignInClick}  className="google-button">
            ...
            } else if (isSignedInState ===  true) {
                return (
                    <button onClick={onSignOutClick} className="btn btn-secondary" >
                    }
                    Sign Out
                    </button>
                )
