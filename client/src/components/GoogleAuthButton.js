...
const GoogleAuthButton = () => {
  ...
  /*construir un botón que trigger una formula. esa fórmula lanza
   ...
   function signOut(){
        alert("imagine that you're signing out")
   }
   
   const authButton  = ()=> {
       return(
    <button type="button" onClick={ loggedIn?  signOut : signInGoogle}  className="google-button">
        ...
        <span className="google-button__text">{loggedIn? "Sign Out":"Sign In"}</span>
    </button>
       )
    }
