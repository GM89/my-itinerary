 ...
 function Login({ setToken }) {
  ...
  return(
    ...
    <p className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Login</p>
          ...
          User status logged in: {loggedIn? "You are logged in":"You are NOT connected"}
          </p>
    ...
    <div className="container py-5 h-100">
      <div className="row d-flex align-items-center justify-content-center h-100">
          ...
          <div className="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
              ...
              <div className="form-outline mb-4">
                <input type="text" 
                  ...
                  <label  htmlFor="name" className="form-label" for="form1Example13">Username</label>
                </div>
                ...
                <input type="email" 
                  ...
                  <label htmlFor="email" className="form-label" for="form1Example13">Email address</label>
                </div>
        ...
        <div className="d-flex justify-content-evenly p-4">
          <button type="button" onClick={loginOut} className="btn btn-primary btn-lg btn-block">Sign Out</button>
